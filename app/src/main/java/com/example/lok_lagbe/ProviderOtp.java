...
public class ProviderOtp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_providerotp);
        otpCode = "";
        phoneNumber = getIntent().getStringExtra("MobileNumber").toString().trim();
        otp1 = (EditText) findViewById(R.id.Otp2Id);
        verify1 = (Button) findViewById(R.id.Verify2Id);
...
//                                    Log.d("TAG", "onSuccess" + user);
                            Intent intent = new Intent(ProviderOtp.this, ProviderLocation.class);
...
//                            });
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                Toast.makeText(ProviderOtp.this,"Incorrect verification Code",Toast.LENGTH_LONG).show();
